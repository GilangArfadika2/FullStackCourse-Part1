...
const StatisticLine = ({text,score}) => {
  return (
    // <p>{text} : {score}</p>
    text === 'positive feedback' ? <p>{text} : {score}%</p> : <p>{text} : {score}</p>
  )
}
...
const History = (props) => {
  ...
  return (
    <div>
      {/* <p>good : {props.good}</p> */}
      <StatisticLine text="good" score={props.good}></StatisticLine>
      {/* <p>neutral : {props.neutral}</p> */}
      <StatisticLine text="neutral" score={props.neutral}></StatisticLine>
      {/* <p>bad : {props.bad}</p> */}
      <StatisticLine text="bad" score={props.bad}></StatisticLine>
      {/* <p>all : {props.totalSum}</p> */}
      <StatisticLine text="all" score={props.totalsum}></StatisticLine>
      {/* <p>average : {props.ave}</p> */}
      <StatisticLine text="average" score={props.ave}></StatisticLine>
      {/* <p>positive feedback : {props.plusFeedback}%</p> */}
      <StatisticLine text="positive feedback" score={props.plusFeedback}></StatisticLine>
    </div>
  )
}
